...
export const HeroSection = () => {
  ...
  const quickStats = [
    { icon: Users, label: "Population", value: "5.1M", arabic: "5.1 مليون" },
    { icon: MapPin, label: "Area", value: "17,818 km²", arabic: "17,818 كم²" },
    { icon: Building, label: "GDP", value: "$200.5B", arabic: "200.5 مليار $" },
    { icon: Globe, label: "Expats", value: "70%", arabic: "%70" },
  ];
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="fade-in-up">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              <Button 
                size="lg" 
                className="bg-kuwait-green hover:bg-primary-glow text-white px-8 py-6 text-lg gold-shadow"
              >
                Explore Kuwait
              ...
              <Button 
                variant="outline" 
                size="lg" 
                className="border-white text-white hover:bg-white hover:text-kuwait-black px-8 py-6 text-lg backdrop-blur-sm"
              >
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 max-w-3xl mx-auto">
            {quickStats.map((stat, index) => (
              <div
                key={index}
                className="marble-gradient p-6 rounded-xl marble-shadow backdrop-blur-sm text-center hover:scale-105 transition-all duration-300"
              >
